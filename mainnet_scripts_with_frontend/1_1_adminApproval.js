...
async function main() {
  ...
  await idoplatformContract.adminApproval(newTokenContract.address, specs.tokenProjectName, amt, ratioForLP, priceForLP, whitelist.length, privateSpecs, publicSpecs, {gasLimit: specs.OneMillionGasLimit,});
}
